    ...
    <Modal
      ...
      <Modal.Body>
        <div className="cmn_modal_header d-flex justify-content-between align-items-center">
          <p className="cmn_modal_title">Delete Event</p>
          <button
        ...
        <div className="mt-3">
          <p className="dash_graymed_text">Are you sure want to delete these Event</p>
...
export const EventPageModels = { DeleteModal }