            ...
            if (selectname) {
                ...
                setFormvalue((prevState) => {
                    ...
                    if (updatedFormValue.accessLevel === "Admin") {
                        let subRoutes = updatedFormValue.restrictions.reduce((acc, currVal) => {
    ...
    const handleedit = async () => {
        ...
        try {
            ...
            if (isEmpty(errs)) {
                ...
                let { status, loading, message, error } = await EditSubAdminData(updatedFormValue);
                if (status) {
                            ...
                            <div className="rp_singleinput_holder mb-3">
                                ...
                                <div className="rp_input_holder rounded-2 px-0">
                                    <Select
                                        ...
                                        value={formvalue.accessLevel ? userTypeStatusOptions.find((val) => (val.value == formvalue.accessLevel)) : ""}
                                        isSearchable={true}
